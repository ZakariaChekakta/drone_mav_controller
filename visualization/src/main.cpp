...
#include <visualization/trajectory_visualizer.h>
...
private:
  ...
  visualization::TrajectoryVisualizer visualizer_;
...
public:
  ...
  //ROS_INFO("x position f%",pose_.getOrigin().x());
  //ROS_INFO("x position f%",pose_.getOrigin().y());
  //ROS_INFO("x position f%",pose_.getOrigin().z());
  }
