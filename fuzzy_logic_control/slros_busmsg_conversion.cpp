...
// Conversions between SL_Bus_fuzzy_logic_control_error_msgs_Error and error_msgs::Error

void convertFromBus(error_msgs::Error* msgPtr, SL_Bus_fuzzy_logic_control_error_msgs_Error const* busPtr)
{
...
void convertToBus(SL_Bus_fuzzy_logic_control_error_msgs_Error* busPtr, error_msgs::Error const* msgPtr)
{
  const std::string rosMessageType("error_msgs/Error");
...
// Conversions between SL_Bus_fuzzy_logic_control_gain_msgs_pid and gain_msgs::pid

void convertFromBus(gain_msgs::pid* msgPtr, SL_Bus_fuzzy_logic_control_gain_msgs_pid const* busPtr)
{
...
void convertToBus(SL_Bus_fuzzy_logic_control_gain_msgs_pid* busPtr, gain_msgs::pid const* msgPtr)
{
  const std::string rosMessageType("gain_msgs/pid");
