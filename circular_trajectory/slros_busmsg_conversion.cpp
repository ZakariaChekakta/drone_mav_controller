...
// Conversions between SL_Bus_circular_trajectory_desired_msgs_Desired and desired_msgs::Desired
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_Accel and geometry_msgs::Accel
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_AccelStamped and geometry_msgs::AccelStamped
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_Point and geometry_msgs::Point
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_Pose and geometry_msgs::Pose
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_PoseStamped and geometry_msgs::PoseStamped
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_Quaternion and geometry_msgs::Quaternion
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_Twist and geometry_msgs::Twist
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_TwistStamped and geometry_msgs::TwistStamped
...
// Conversions between SL_Bus_circular_trajectory_geometry_msgs_Vector3 and geometry_msgs::Vector3
...
// Conversions between SL_Bus_circular_trajectory_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_circular_trajectory_std_msgs_Header and std_msgs::Header
